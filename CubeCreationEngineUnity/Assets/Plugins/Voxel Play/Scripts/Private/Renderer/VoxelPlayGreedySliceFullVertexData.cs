...
namespace VoxelPlay
{
	...
	public class VoxelPlayGreedySliceFullVertexData
	{
		...
		public void FlushTriangles (FACE_DIRECTION direction, int slice, List<Vector3> vertices, List<int>indices, List<Vector4>uv0, List<Vector3>normals, List<Color32>colors)
		{
			if (qqCount == 0) {
				return;
			}
