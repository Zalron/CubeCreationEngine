...
namespace VoxelPlay
{
	...
	public class VoxelPlayGreedySliceLit
	{
		...
		public void AddQuad (int x, int y, ref Color32 color, float light, int textureIndex)
		{
			...
			for (int k = 0; k < qqCount; k++) {
				...
				for (int j = k + 1; j < qqCount; j++) {
					...
					if (q1.y == q2.y && q1.h == q2.h && q1.x + q1.w == q2.x && q1.textureIndex == q2.textureIndex && q1.light == q2.light && q1.color.r == q2.color.r && q1.color.g == q2.color.g && q1.color.b == q2.color.b) {
						...
						q2.used = true;
						continue;
					} else if (q1.x == q2.x && q1.w == q2.w && q1.y + q1.h == q2.y && q1.textureIndex == q2.textureIndex && q1.light == q2.light && q1.color.r == q2.color.r && q1.color.g == q2.color.g && q1.color.b == q2.color.b) {
						q1.h += q2.h;
						q2.used = true;
						continue;
					}
