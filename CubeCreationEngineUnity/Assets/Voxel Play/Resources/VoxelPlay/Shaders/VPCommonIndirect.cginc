...
#define VOXELPLAY_COMMON_INDIRECT
    ...
    void VPObjectToWorldMatrix(float4 position, float4 rotationQuaternion) {
        VPObjectToWorld = ConvertQuaternion(rotationQuaternion);
       	...
       	unity_ObjectToWorld._14_24_34_44 = float4(position[0], position[1], position[2], 1);
        unity_ObjectToWorld._11_21_31_41 = float4(VPObjectToWorld[0][0], VPObjectToWorld[0][1], VPObjectToWorld[0][2], 0);
        unity_ObjectToWorld._12_22_32_42 = float4(VPObjectToWorld[1][0], VPObjectToWorld[1][1], VPObjectToWorld[1][2], 0);
        unity_ObjectToWorld._13_23_33_43 = float4(VPObjectToWorld[2][0], VPObjectToWorld[2][1], VPObjectToWorld[2][2], 0);
    }
