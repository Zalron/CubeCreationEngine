    ...
    public class VoxelPlayEnvironmentEditor : Editor
    {
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (expandQualitySection) {
                ...
                if (!GUI.enabled) {
                    EditorGUILayout.BeginHorizontal ();
                    EditorGUILayout.LabelField (new GUIContent ("Geometry Shaders", "Uses geometry shaders to render voxels. Not supported on mobile nor WebGL."), GUILayout.Width (EditorGUIUtility.labelWidth));
